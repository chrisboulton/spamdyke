# This test configures and compiles spamdyke with default options to check for
...
pushd ${SPAMDYKE_DIR}
make distclean
echo "./configure > ${TMPDIR}/${TEST_NUM}-output.txt 2>&1"
./configure > ${TMPDIR}/${TEST_NUM}-output.txt 2>&1
