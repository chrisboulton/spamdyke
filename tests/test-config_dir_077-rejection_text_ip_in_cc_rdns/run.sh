...
echo rejection-text-ip-in-cc-rdns=Foo Bar Baz >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
echo reject-ip-in-cc-rdns >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
