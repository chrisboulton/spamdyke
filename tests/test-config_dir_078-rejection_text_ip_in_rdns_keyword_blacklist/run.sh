...
echo rejection-text-ip-in-rdns-keyword-blacklist=Foo Bar Baz >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
echo ip-in-rdns-keyword-blacklist-file=${TMPDIR}/${TEST_NUM}-rdns_keywords.txt >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
