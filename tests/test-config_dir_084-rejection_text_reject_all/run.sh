...
echo rejection-text-reject-all=Foo Bar Baz >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
echo filter-level=reject-all >> ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example
