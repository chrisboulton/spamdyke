...
# that matches the partial rDNS name.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_dir}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}
