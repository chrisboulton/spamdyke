...
# that matches the 4 octets of the IP address and the full rDNS name.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_dir}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_path}
