...
# that matches the full rDNS name, the 4 octets of the IP address and the
# full sender address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_sender_/com/example/_at_
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_sender_/com/example/_at_/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_sender_/com/example/_at_/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_sender_/com/example/_at_/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_sender_/com/example/_at_/${FROM_USERNAME}
