...
# that matches the full rDNS name, the full recipient address and the
# full sender address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example/_at_
...
echo policy-url=betty > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example/_at_/betty
echo policy-url=pearl > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example/_at_/pearl
echo policy-url=tex > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example/_at_/tex
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_dir}/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_dir}/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_dir}/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example/_at_/${FROM_USERNAME}
