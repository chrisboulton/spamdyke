...
# that matches the full sender address, the 4 octets of the IP address and
# the full rDNS name.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_dir}
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/1
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/1
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/2
echo policy-url=foo > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_dir}/1
echo policy-url=bar > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_dir}/2
echo policy-url=baz > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_dir}/3
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_rdns_/${rdns_path}
