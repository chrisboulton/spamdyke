...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}/_rdns_/${rdns_dir}
...
echo policy-url=betty > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/betty
echo policy-url=pearl > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/pearl
echo policy-url=tex > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/tex
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}/_rdns_/${rdns_dir}/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}/_rdns_/${rdns_dir}/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}/_rdns_/${rdns_dir}/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}/_rdns_/${rdns_path}
