...
# that matches the full sender address, the full rDNS name, the 4 octets of
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_dir}/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}/_recipient_/${recipient_path}
