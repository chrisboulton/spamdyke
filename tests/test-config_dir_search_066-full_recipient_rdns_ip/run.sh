...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}
