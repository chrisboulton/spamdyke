...
# that matches the full recipient address, the full sender address and
# the 4 octets of the IP address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/${FROM_USERNAME}/_ip_/${octet_1}/${octet_2}/${octet_3}/${octet_4}
