...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_dir}
...
echo policy-url=betty > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/betty
echo policy-url=pearl > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/pearl
echo policy-url=tex > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/tex
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_sender_/com/example/_at_/${FROM_USERNAME}/_rdns_/${rdns_path}
