...
# that matches the first 3 octets of the IP address and the partial recipient address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_ip_/${octet_1}/${octet_2}/${octet_3}/_recipient_/${recipient_dir}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_ip_/${octet_1}/${octet_2}/${octet_3}/_recipient_/${recipient_path}
