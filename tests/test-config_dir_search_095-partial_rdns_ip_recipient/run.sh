...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_recipient_/${recipient_dir}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_recipient_/${recipient_path}
