...
# that matches the partial rDNS name, the partial recipient address and the first 3
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}/0
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}/1
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}/2
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}/${octet_3}
