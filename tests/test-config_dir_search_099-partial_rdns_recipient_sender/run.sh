...
# that matches the partial rDNS name, the partial recipient address and the
# partial sender address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com
...
echo policy-url=betty > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/betty
echo policy-url=pearl > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/pearl
echo policy-url=tex > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/tex
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_recipient_/${recipient_path}/_sender_/com/example
