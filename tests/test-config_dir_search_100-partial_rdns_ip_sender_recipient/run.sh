...
# that matches the partial rDNS name, the first 3 octets of the IP address, the
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/example/_recipient_/${recipient_dir}
...
echo policy-url=betty > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/betty
echo policy-url=pearl > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/pearl
echo policy-url=tex > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/tex
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/example/_recipient_/${recipient_dir}/dino
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/example/_recipient_/${recipient_dir}/pebbles
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/example/_recipient_/${recipient_dir}/bambam
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_rdns_/${rdns_path}/_ip_/${octet_1}/${octet_2}/${octet_3}/_sender_/com/example/_recipient_/${recipient_path}
