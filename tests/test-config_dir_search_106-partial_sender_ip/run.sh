...
# that matches the partial sender address and the first 3 octets of the IP address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}
