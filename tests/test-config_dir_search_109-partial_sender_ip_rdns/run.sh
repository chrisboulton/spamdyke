...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}/_rdns_/${rdns_dir}
...
echo policy-url=dino > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/1
echo policy-url=pebbles > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/1
echo policy-url=bambam > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/2
echo policy-url=foo > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}/_rdns_/${rdns_dir}/1
echo policy-url=bar > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}/_rdns_/${rdns_dir}/2
echo policy-url=baz > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}/_rdns_/${rdns_dir}/3
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_ip_/${octet_1}/${octet_2}/${octet_3}/_rdns_/${rdns_path}
