...
# that matches the partial sender address, the partial recipient
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_recipient_/${recipient_path}/_ip_/${octet_1}/${octet_2}/${octet_3}
