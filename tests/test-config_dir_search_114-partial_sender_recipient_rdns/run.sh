...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_recipient_/${recipient_path}/_rdns_/${rdns_dir}
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_sender_/com/example/_recipient_/${recipient_path}/_rdns_/${rdns_path}
