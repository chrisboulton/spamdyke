...
# that matches the partial recipient address, the partial rDNS name and
# the partial sender address.
...
mkdir -p ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_rdns_/${rdns_path}/_sender_/com
...
echo reject-unresolvable-rdns > ${TMPDIR}/${TEST_NUM}-config.d/_recipient_/${recipient_path}/_rdns_/${rdns_path}/_sender_/com/example
