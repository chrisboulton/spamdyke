...
echo rejection-text-ip-blacklist=Foo Bar Baz >> ${TMPDIR}/${TEST_NUM}-config.txt
echo ip-blacklist-file=${TMPDIR}/${TEST_NUM}-blacklist_ip.txt >> ${TMPDIR}/${TEST_NUM}-config.txt
