...
echo rejection-text-rdns-blacklist=Foo Bar Baz >> ${TMPDIR}/${TEST_NUM}-config.txt
echo rdns-blacklist-file=${TMPDIR}/${TEST_NUM}-blacklist_rdns.txt >> ${TMPDIR}/${TEST_NUM}-config.txt
